...
_0x3:
	.DB  0x50,0x6F,0x6F,0x72,0x69,0x61,0x20,0x52
	.DB  0x61,0x68,0x69,0x6D,0x69,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0025     char input;
; 0000 0026     char name[] = "Pooria Rahimi";
; 0000 0027     int i = 0;
...
; 0000 00A6         input = getchar();
	CALL _getchar
	MOV  R17,R30
; 0000 00A7         putchar(input);
	MOV  R26,R17
	CALL _putchar
; 0000 00A8         putchar(0x0d);
	CALL SUBOPT_0x0
; 0000 00A9         putchar(0x0a);
; 0000 00AA         if (input == 'C')
	CPI  R17,67
	BRNE _0x7
; 0000 00AB         {
; 0000 00AC             lcd_clear();
...
; 0000 00B0             puts(name);
	MOVW R26,R28
	CALL _puts
; 0000 00B1             putchar(0x0d);
	CALL SUBOPT_0x0
; 0000 00B2             putchar(0x0a);
; 0000 00B3         }
; 0000 00B4         else if(input == 'c')
	RJMP _0xA
_0x9:
	CPI  R17,99
	BRNE _0xB
; 0000 00B5         {
; 0000 00B6             for (i = 0; i < 24;i++){
	__GETWRN 18,19,0
_0xD:
	__CPWRN 18,19,24
	BRGE _0xE
; 0000 00B7                 putchar(0x0d);
	CALL SUBOPT_0x0
; 0000 00B8                 putchar(0x0a);
; 0000 00B9             }
	__ADDWRN 18,19,1
	RJMP _0xD
_0xE:
; 0000 00BA         }
; 0000 00BB         else if( input == 'M')
	RJMP _0xF
_0xB:
	CPI  R17,77
	BRNE _0x10
